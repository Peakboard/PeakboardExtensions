...
namespace Firebird
{
    ...
    public class FirebirdCustomList : CustomListBase
    {
        ...
        protected override CustomListObjectElementCollection GetItemsOverride(CustomListData data)
        {
            ...
            FbConnection connection = OpenConnection(data);
            FbDataReader dataReader = ReadStatement(data, connection);
            ...
            this.Log?.Info(string.Format("Firebird extension fetched {0} rows.", items.Count));
