    ...
    public class BacNetPropertiesCustomList : CustomListBase
    {
        ...
        public BacNetPropertiesCustomList()
        {
            _bacnetPropertiesMap = Enum.GetValues(typeof(BacnetPropertyIds))
                ...
                .GroupBy(e => e.ToString().Replace("PROP_", "").ToPascalCase(), StringComparer.OrdinalIgnoreCase)
                .Select(g => g.First())
                .ToDictionary(
        ...
        protected override CustomListColumnCollection GetColumnsOverride(CustomListData data)
        {
            try
            {
                ...
                _propertyReader = new BacNetPropertyReader(client, _bacnetObjectNameToTypeMap,_logger, ref _objectsDescriptionExternal, ref _objectsDescriptionDefault);
        ...
        protected override void SetupOverride(CustomListData data)
        {
            try
            {
                ...
                var client = BacNetHelper.CreateBacNetClient(data);
                _subscriptionManager = new BacNetSubscriptionManager(client, _bacnetObjectNameToTypeMap,_logger);
        ...
        protected override CustomListExecuteReturnContext ExecuteFunctionOverride(CustomListData data, CustomListExecuteParameterContext context)
        {
            ...
            {
                var client = BacNetHelper.CreateBacNetClient(data);
                _propertyWriter = new BacNetPropertyWriter(client, _bacnetPropertiesMap, _bacnetObjectNameToTypeMap,_logger);
