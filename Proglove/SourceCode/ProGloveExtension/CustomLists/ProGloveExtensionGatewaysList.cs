    ...
    public class ProGloveExtensionGatewaysList : CustomListBase
    {
        ...
        protected override CustomListColumnCollection GetColumnsOverride(CustomListData data)
        {
            return new CustomListColumnCollection
            {
                ...
                new CustomListColumn("Deleted", CustomListColumnTypes.Boolean),
                ...
                new CustomListColumn("Latitude", CustomListColumnTypes.Number),
                new CustomListColumn("Longitude", CustomListColumnTypes.Number),
